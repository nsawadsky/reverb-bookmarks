...
include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../native/ReverbIndexerClient/public)

target_link_libraries(${PROJECT_NAME} debug ${CMAKE_CURRENT_SOURCE_DIR}/../../native/ReverbIndexerClient/xpnp/debug/XpNamedPipe.lib)
target_link_libraries(${PROJECT_NAME} optimized ${CMAKE_CURRENT_SOURCE_DIR}/../../native/ReverbIndexerClient/xpnp/release/XpNamedPipe.lib)

target_link_libraries(${PROJECT_NAME} debug ${CMAKE_CURRENT_SOURCE_DIR}/../../native/ReverbIndexerClient/jsoncpp/json_vc71_libmtd.lib)
target_link_libraries(${PROJECT_NAME} optimized ${CMAKE_CURRENT_SOURCE_DIR}/../../native/ReverbIndexerClient/jsoncpp/json_vc71_libmt.lib)
    
target_link_libraries(${PROJECT_NAME} debug ${CMAKE_CURRENT_SOURCE_DIR}/../../native/Debug/ReverbIndexerClient.lib)
target_link_libraries(${PROJECT_NAME} optimized ${CMAKE_CURRENT_SOURCE_DIR}/../../native/Release/ReverbIndexerClient.lib)
...
add_wix_installer( ${PLUGIN_NAME}
    ${CMAKE_CURRENT_SOURCE_DIR}/Win/WiX/ReverbInstaller.wxs
    PluginDLLGroup
